...
public class HomeCarGUI extends JFrame implements CarManager{
	 ...
	 * Create the frame.
	 */
	public HomeCarGUI() throws Exception, ClassNotFoundException {
		UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
		this.setLocationRelativeTo(null);
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(TrangChuGUI.LOCAL_PATH+"car.png"));
		this.setTitle("HOME CAR");
		...
		scrollPane.setBounds(422, 77, 719, 273);
		...
		lblName.setBounds(23, 115, 90, 21);
		contentPane.add(lblName);
		
		textFieldName = new JTextField(); 
		textFieldName.setBounds(146, 117, 203, 21);
		...
		lblPrice.setBounds(23, 173, 90, 21);
		contentPane.add(lblPrice);
		
		textFieldPrice = new JTextField();
		textFieldPrice.setColumns(10);
		textFieldPrice.setBounds(146, 175, 203, 21);
		...
		lblTotal.setBounds(23, 225, 90, 20);
		contentPane.add(lblTotal);
		
		textFieldTotal = new JTextField();
		textFieldTotal.setColumns(10);
		textFieldTotal.setBounds(146, 228, 203, 19);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Car car = takeValueCar(String.valueOf(Integer.parseInt(list.get(list.size()-1).getProduct_id()) + 1));
				if(!addCar(car)) {
		...
		btnAdd.setBounds(899, 397, 106, 27);
		...
		btnEdit.setBounds(1035, 397, 106, 27);
		...
		btnDel.setBounds(899, 446, 106, 27);
		...
		lblNewLabel.setBounds(23, 403, 177, 21);
		...
		comboBoxTypeSearch.setBounds(210, 397, 214, 27);
		...
		lblNewLabel_1.setBounds(23, 497, 165, 19);
		contentPane.add(lblNewLabel_1);
		
		textFieldSearch = new JTextField();
		textFieldSearch.setBounds(210, 495, 214, 27);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(valueSearch.trim().toLowerCase().equals(comboBoxTypeSearch.getItemAt(0).toString().toLowerCase())) {
					...
					try {
						...
						listSearch = searchCarBySeat(seat);
						showTable(listSearch);
					} catch (Exception e2) {
						JOptionPane.showMessageDialog(contentPane, "Số liệu nhập vào không hợp lệ!");
		...
		btnSearch.setBounds(214, 546, 106, 27);
		...
		btnReset.setBounds(1035, 446, 106, 27);
		...
		lblNewLabel_2.setBounds(482, 399, 153, 21);
		...
		comboBoxTypeSort.setBounds(645, 397, 214, 27);
		...
		comboBoxSort.setBounds(645, 446, 214, 27);
		contentPane.add(comboBoxSort);
		
		textFieldSort = new JTextField();
		textFieldSort.setBounds(645, 495, 214, 27);
		...
		btnSort.setBounds(645, 546, 106, 27);
		...
		lblNewLabel_3.setBounds(43, 71, 277, 34);
		...
		lblNewLabel_4.setBounds(482, 497, 153, 19);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("CAR MANAGEMENT");
	...
	public boolean checkValue() {
		...
		try {
			...
			else if(Integer.parseInt(textFieldSeat.getText()) < 0)
	...
	public Car takeValueCar(String id) {
		Car car = new Car();
